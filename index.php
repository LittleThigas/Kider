                  ...
                  <div class="row g-0">
                     <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="h-100 d-flex flex-column justify-content-center p-5">
                           ...
                           <form action="contato_salvar.php" method="post">
                              <div class="row g-3">
                                 <div class="col-sm-6">
                                 ...
                                 <div class="col-12">
                                    <div class="form-floating">
                                       <input class="form-control border-0" placeholder="Deixa uma mensagem aqui" id="message" name="Mensagem" style="height: 100px"></input>
